...
class DeleteByCondictionsDemo extends StatefulWidget {
  @override
  _DeleteByCondictionsDemoState createState() => _DeleteByCondictionsDemoState();
}

class _DeleteByCondictionsDemoState extends State<DeleteByCondictionsDemo>{
